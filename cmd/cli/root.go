...
var rootCommand = RootCmd{
	cobraCommand: &cobra.Command{
		Use:   "cli",
		Short: "cli is basic template for making golang cli apps",
		Long:  `cli is basic template for making golang cli apps.`,
	},
}
...
func NewCmdRoot(out io.Writer) *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&rootCommand.configFile, "config", "", "config file (default is $HOME/.cli.yaml)")
